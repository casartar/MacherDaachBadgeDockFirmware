...
const char HTTP_PORTAL_OPTIONS[] PROGMEM  = "<form action=\"/wifi\" method=\"get\"><button>WiFi Konfigurieren</button></form><br/><form action=\"/0wifi\" method=\"get\"><button> WiFi Konfigurieren (Ohne Suche)</button></form><br/><form action=\"/i\" method=\"get\"><button>Info</button></form><br/><form action=\"/r\" method=\"post\"><button>Zurücksetzen</button></form>";
